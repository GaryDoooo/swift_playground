...
let hints = [
    NSLocalizedString("You can tap a tile to see its coordinate value. Find the location you’d like your expert to start at, then tap the tile to figure out which column and row value to pass into your `place` method.", comment:"Hint"),
