...
let hints = [
NSLocalizedString("The [array out of bounds error](glossary://array%20out%20of%20bounds%20error) happens when you try to use an index that’s outside of that array’s bounds.", comment:"Hint"),
...
NSLocalizedString("Make sure you aren’t removing any more code than is necessary to correct the [array out of bounds error](glossary://array%20out%20of%20bounds%20error). If you can’t figure out what you already deleted, try resetting the page by tapping the three-dot icon and tapping \"Reset Page\".", comment:"Hint")
]
