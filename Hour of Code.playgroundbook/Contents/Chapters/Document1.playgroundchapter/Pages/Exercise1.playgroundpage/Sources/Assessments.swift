...
let checker = ContentsChecker(contents: PlaygroundPage.current.text)
    ...
    var hints = [
        ...
        NSLocalizedString("First tap `moveForward()` three times, and then tap `collectGem()`. If you have problems with your code, you can start over by tapping the three-dot icon at the top of the page and then tapping Reset Page.", comment:"Hint")
    ]
