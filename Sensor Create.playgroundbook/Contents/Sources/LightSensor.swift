...
public class LightSensor: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    public func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        CMSampleBufferCreateCopy(kCFAllocatorDefault, sampleBuffer, &self.capturedBuffer)
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            if let lightSensorImage = self.imageFromBuffer(sampleBuffer: sampleBuffer) {
                ...
                if let didSenseLightHandler = self.didSenseLightHandler {
                    DispatchQueue.main.async {
...
public extension UIColor {
    /// Red is one of the colors you can access from the camera data. You can also access the data for green and blue. The color information is a double between 0 and 1.
    ///
    /// - localizationKey: red
    ...
    /// Green is one of the colors you can access from the camera data. You can also access the data for red and blue. The color information is a double between 0 and 1.
    ///
    ...
    /// Blue is one of the colors you can access from the camera data. You can also access the data for red and green. The color information is a double between 0 and 1.
    ///
