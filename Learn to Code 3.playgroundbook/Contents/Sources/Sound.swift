...
/// An enumeration of all the different sounds that can be played. These sounds include bark, bluDance, bluLookAround, bluHeadScratch, bluOops, boing, data, electricity, hat, horse, knock, owl, phone, pop, snare, tennis, tick, tumble, walrus, wap and warp.
///
