...
/// An enumeration of different tweaks that can be applied to an instrument. These can be pitch, speed, and volume.
///
...
public struct SpeechTweak {
    ...
    ///
    /// - Parameter type: The type of speech tweek.
    /// - Parameter effectFrom: The starting value of the effect.
    /// - Parameter to: The ending value of the effect.
    ///
