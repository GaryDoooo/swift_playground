...
public class Image: _ExpressibleByImageLiteral, Equatable, Hashable {
    ...
    static private func parseDescription(from path: String) -> String {
        ...
        case "storyframe":
            name = NSLocalizedString("story frame", comment: "AX description of an image")
        case "blackhole":
            name = NSLocalizedString("black holr", comment: "AX description of an image")
        case "blu1":
            name = NSLocalizedString("blu", comment: "AX description of an image")
        case "blu2":
            name = NSLocalizedString("blue", comment: "AX description of an image")
        case "byte1":
