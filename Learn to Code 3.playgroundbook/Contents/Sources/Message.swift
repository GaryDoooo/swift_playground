...
public indirect enum Message: RawRepresentable {
    ...
    case moveAndRemove(id: String, position: CGPoint, duration: Double, sound: Sound?)
    ...
    public init?(rawValue: RawValue) {
        ...
        case .moveAndRemove:
            if
                ...
                let sound = decoder.sound
                self = .moveAndRemove(id: id, position: position, duration: duration, sound: sound)
                return
            }
    ...
    public var rawValue: PlaygroundValue {
        ...
        case .moveAndRemove(let id, let position, let duration, let sound):
            encoder.messageType = .moveAndRemove
            encoder.id = id
