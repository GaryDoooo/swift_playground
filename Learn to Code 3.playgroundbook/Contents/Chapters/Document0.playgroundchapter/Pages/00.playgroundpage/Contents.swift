 ...
 * ⚡️ **Goodbye**: Tumble emoji out of the universe by touching them.
 ...
 You can even just reach over and tap the **Astrodance** button to get those emoji moving! 💃🏻🕺🏻
 
 Before you [move on](@next), try a tiny bit of coding. Choose different emoji, or a different number of dancers, by editing the code. After you make your changes, tap **Run My Code**. Then tap **Astrodance** to make your emoji dance again.
 */
//#-hidden-code
