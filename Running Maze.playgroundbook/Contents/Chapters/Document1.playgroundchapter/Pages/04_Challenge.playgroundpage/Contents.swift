...
/*:#localized(key: "SecondProseBlock")
 Try switching the maze type from `.simple` to `.medium`, `.hard`, or `.impossible`. How does the A* algorithm compare to breadth-first search on the different maze types?
 */
