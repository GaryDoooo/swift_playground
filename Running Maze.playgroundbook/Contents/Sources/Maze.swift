...
public class Maze {
    ...
    /// - localizationKey: Maze.coordinateIsValid(_:)
    ...
    /// - localizationKey: Maze.searchNeighbors(of:)
    ...
    /// - localizationKey: Maze.pathDistance(to:)
    ...
    /// - localizationKey: Maze.details(for:)
    ...
    /// - localizationKey: Maze.setDetails(_:for:)
