...
// TODO: sceneModel was declared as non-optional on day 1, so not doing any null checks like the ObjC code does. You'll need to upgrade this method to support teardown in the future.
...
public class SLOTAnimationView : UIView, CAAnimationDelegate {
    ...
    func restoreState() {
        // TODO: !!! hitting the `else` case that sets progress to itself to trigger a setter, but that will cause inf loop since we don't have direct iVar access. As work-around, call the function that was inevitably triggered.
    ...
    private func _layout() {
        ...
        //        compContainer.viewportBounds = compBounds // TODO: property doesn't exist yet
