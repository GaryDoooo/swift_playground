...
public class ThingView: UIView {
    ...
    func update() {
        ...
        layer.borderColor = isSelected ? UIColor.hocThingSelectedColor.cgColor : UIColor.clear.cgColor
    ...
    @objc public func describeYourself() -> Void {
        UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, item.accessibilityDescription)
    }
}
