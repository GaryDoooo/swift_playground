...
extension UIView {
    ...
    func wobbleAndShake(speed: Speed = .normal) {
        ...
        wobbleAnimation.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionLinear)
    ...
    func jiggle(enabled: Bool) {
        ...
        shakeAnimation.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseInEaseOut)
        ...
        0.0]
        wobbleAnimation.fillMode = kCAFillModeForwards
        wobbleAnimation.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseInEaseOut)
        wobbleAnimation.isRemovedOnCompletion = true
