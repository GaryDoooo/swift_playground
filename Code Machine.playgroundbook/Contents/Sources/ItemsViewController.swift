...
class ItemsViewController: UIViewController {
    ...
    var orientation = UILayoutConstraintAxis.vertical
    ...
    private var collectionViewSize: CGSize {
        ...
        // Horizontal layout.
        if orientation == UILayoutConstraintAxis.horizontal {
...
extension ItemsViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        ...
        if orientation == UILayoutConstraintAxis.vertical {
        ...
        } else if orientation == UILayoutConstraintAxis.horizontal {
