...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
        NSLocalizedString("Add a `for` loop to your code by tapping `for` in the shortcut bar.", comment:"Hint"),
    ...
    if checker.didUseWhileLoop {
        ...
        hints[0] = NSLocalizedString("Add a `for` loop to your code by tapping `for` in the shortcut bar. Drag the bottom curly brace down to bring the existing commands up into the loop.", comment:"Hint")
    }
