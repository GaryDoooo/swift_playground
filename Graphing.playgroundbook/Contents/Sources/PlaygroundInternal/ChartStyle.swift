...
internal class ChartStyle {
    ...
    lazy var axisLabelAttributes: [NSAttributedStringKey: Any] = [
    ...
    func calloutTitleLabelAttributesWith(color: Color) -> [NSAttributedStringKey: Any] {
        return [
    ...
    lazy var calloutFieldTitleLabelAttributes: [NSAttributedStringKey: Any] = [
    ...
    /// The string attributes to apply to the label for the callout field title.
    lazy var calloutFieldValueLabelAttributes: [NSAttributedStringKey: Any] = [
        .font: self.calloutLabelFont,
