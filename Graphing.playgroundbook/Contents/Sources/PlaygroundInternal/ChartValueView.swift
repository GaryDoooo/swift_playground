...
@objc(GraphingCalloutView)
private class CalloutView: UIView {
    
    @objc(GraphingCalloutViewCalloutContentView)
    private class CalloutContentView: UIView {
        ...
        private func valueLabelWidthFor(characterCount: Int, attributes: [NSAttributedStringKey: Any]) -> CGFloat {
